...
2. **dishi.name** — identity, attachment, sharing (taste-rank + messenger
   ...
   and the batch is SPEC'D as of 2026-07-28 (owner design session): see
   "Batch: sharing — messenger share + per-dish links" at the end of this
   file. Six items, sequencing at its foot; `/i` is CLOSED by it.
