...
// House — home cooking (屋企煮). One of the three equal-weight segments in the
// merged log-entry pill (.log-src-merged): restaurant / home cooking / old
// photos all count the same, so all three sit together, white on ink.
