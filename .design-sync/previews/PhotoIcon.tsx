...
// Photo / picture — an old camera-roll shot (相簿舊菜). One of the three
// equal-weight segments in the merged log-entry pill (.log-src-merged):
// restaurant / home cooking / old photos all count the same, so all three
// sit together, white on ink.
