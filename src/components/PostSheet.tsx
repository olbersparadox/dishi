      ...
      footer={
        ...
        <div style={{ display: 'flex', gap: 8, marginTop: 16, justifyContent: 'center' }}>
          {dish.posted && (
            ...
            // cancel, so the icon says so. Same size as its icon-btn siblings
            // (16px) — only the icon's own slash extends past its box to
            // cross the button; the globe itself doesn't change size.
