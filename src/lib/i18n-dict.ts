...
export const dict: Record<string, { zh: string; en: string }> = {
  ...
  'grow.toready': { zh: '仲差 {n} 碟，Taste AI 1.0 就 Ready', en: '{n} more dishes to Taste AI 1.0' },
  'grow.ready': { zh: 'Taste AI 1.0 Ready 喇', en: 'Taste AI 1.0 ready' },
  'grow.reanalysing': { zh: '重新分析緊…', en: 're-analysing…' },
  'grow.close': { zh: '閂咗佢', en: 'Close' },
