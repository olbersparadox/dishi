...
export const dict: Record<string, { zh: string; en: string }> = {
  ...
  'scan.reading': { zh: '讀緊個菜牌…', en: 'Reading the menu\u2026' },
  'scan.pick': { zh: '記低呢道', en: 'Pick this dish' },
  'scan.picked': { zh: '已記低', en: 'Picked' },
  'scan.ingredients': { zh: '主要材料', en: 'Key ingredients' },
  ...
  'scan.cooking.fried': { zh: '炸', en: 'Fried' },
  'scan.cooking.steamed': { zh: '蒸', en: 'Steamed' },
  'scan.cooking.grilled': { zh: '燒烤', en: 'Grilled' },
  'scan.cooking.braised': { zh: '炆', en: 'Braised' },
  'scan.cooking.baked': { zh: '焗', en: 'Baked' },
  'scan.cooking.raw': { zh: '生食', en: 'Raw' },
  'scan.cooking.stir-fried': { zh: '小炒', en: 'Stir-fried' },
  'scan.cooking.boiled': { zh: '煮', en: 'Boiled' },
  'scan.cooking.other': { zh: '其他做法', en: 'Other' },
  'scan.heaviness.light': { zh: '輕', en: 'Light' },
  'scan.heaviness.medium': { zh: '中', en: 'Medium' },
  'scan.heaviness.heavy': { zh: '重', en: 'Heavy' },
