...
export const dict: Record<string, { zh: string; en: string }> = {
  ...
  'snapdemo.again': { zh: '再試多次', en: 'Try again' },
  // End-of-stack consent + review (the trust gate)
  'rate.review.title': { zh: '儲存並成長你嘅 Taste AI？', en: 'Save & grow your Taste AI?' },
  'rate.review.blurb': { zh: '呢啲評分會教你嘅 Taste AI。確認前可以微調或者剔走。', en: 'These ratings teach your Taste AI. Nudge or drop any before you confirm.' },
  'rate.review.dish': { zh: '第 {n} 道', en: 'Dish {n}' },
  'rate.review.drop': { zh: '唔計', en: 'Drop' },
  'rate.review.keep': { zh: '計返', en: 'Keep' },
  'rate.review.lower': { zh: '調低', en: 'Lower' },
  'rate.review.higher': { zh: '調高', en: 'Higher' },
  'rate.review.discard': { zh: '唔儲住', en: 'Discard' },
  'rate.review.confirm': { zh: '確認 {n} 個', en: 'Confirm {n}' },
  // The "growing your Taste AI" reward (after consent)
  'rate.grow.title': { zh: '你嘅 Taste AI 更識你', en: 'Your Taste AI knows you better' },
  'rate.grow.taught': { zh: '+{n} 道菜教咗佢', en: '+{n} dishes taught it' },
  'rate.grow.level': { zh: '等級 {n}', en: 'Level {n}' },
  'rate.grow.remain': { zh: '再 {p}% 解鎖 AI 人格匯出', en: '{p}% to unlock your AI persona export' },
  'rate.grow.unlocked': { zh: '🎉 解鎖咗 AI 人格匯出！', en: '🎉 AI persona export unlocked!' },
  'rate.grow.done': { zh: '完成', en: 'Done' },
  // Progressive "watch your Taste AI learn" screen (merged reward + review)
  'grow.work.title': { zh: 'Dishi 試緊你揀嘅菜…', en: 'Dishi is tasting your dishes…' },
  'grow.work.sub': { zh: '{done} / {n} 味分析好', en: '{done} of {n} analysed' },
  ...
  'grow.refine.hint': { zh: '揀返餐廳、改個名 — 都會教多你嘅 Taste AI', en: 'Pick the spot or fix a name — each one teaches your Taste AI more' },
  'grow.rename': { zh: '改名', en: 'Rename' },
  'grow.stat.dishes': { zh: '道菜', en: 'dishes' },
  'grow.stat.learned': { zh: '學到', en: 'learned' },
  'grow.stat.placed': { zh: '確認咗', en: 'placed' },
  'place.home': { zh: '住家菜', en: 'Home cooked' },
  'grow.leave.bg': { zh: '之後再睇（喺後台繼續分析）', en: 'Leave — finishes in the background' },
  'grow.leave.done': { zh: '得喇 · 睇下 Taste AI', en: 'Done — see my Taste AI' },
